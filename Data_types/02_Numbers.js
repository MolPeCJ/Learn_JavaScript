...
// Правильный механизм isFinite и бесконечный цикл while, неправильно if-ыбыли расставлены

// Бесконечный цикл по ошибке
// Потому что i != 10 никогда не произойдет
...
// Случайное целое число от min до max 
// Придумал простое и НЕправильное решение :)
// Одно из возможных решений - использовать вместо Math.round - Math.floor и добавить
// к max - min + 1, так все значения будут появлятся с равной долей вероятности